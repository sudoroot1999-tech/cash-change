...
export class ValidationFactory {
     ...
     */
    static validateJoi<T>(schema: Joi.Schema, data: unknown): T {
     ...
     */
    static isValidCryptoAddress(address: string, type: 'BTC' | 'ETH' | 'SOL'): boolean {
        switch (type) {
            case 'BTC':
     ...
     */
    static containsNoSQLInjection(input: any): boolean {
     ...
     */
    static isValidAmount(amount: string | number, decimals: number = 8): boolean {
