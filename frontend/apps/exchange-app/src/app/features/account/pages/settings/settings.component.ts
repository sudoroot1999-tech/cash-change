            ...
            @case ('general') {
              <ui-card variant="elevated" title="General Settings">
                ...
                <div class="form-actions">
                  <ui-button variant="primary" (click)="saveSettings()">Save Changes</ui-button>
                </div>
              </ui-card>
            }
              ...
              <ui-card variant="elevated" title="Notification Preferences">
                <div class="notifications-list">
                  ...
                  <div class="notification-item">
                    ...
                    <label class="toggle">
                      <input type="checkbox" [(ngModel)]="settings.tradeNotifications">
                      <span class="toggle-slider"></span>
                    </label>
                  </div>
                  ...
                  <div class="notification-item">
                    ...
                    <label class="toggle">
                      <input type="checkbox" [(ngModel)]="settings.priceAlerts">
                      <span class="toggle-slider"></span>
                    </label>
                  </div>
                  ...
                  <div class="notification-item">
                    ...
                    <label class="toggle">
                      <input type="checkbox" [(ngModel)]="settings.marketingEmails">
                      <span class="toggle-slider"></span>
                    </label>
                  </div>
                </div>
              ...
              <ui-card variant="elevated" title="Trading Preferences">
                <div class="settings-form">
                  <div class="form-group">
                    ...
                    <select class="form-select" [(ngModel)]="settings.defaultPair">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-select" [(ngModel)]="settings.chartType">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-select" [(ngModel)]="settings.defaultTimeframe">
                  ...
                  <div class="form-group">
                    ...
                    <div class="checkbox-group">
                      <label class="checkbox-label">
                        <input type="checkbox" [(ngModel)]="settings.confirmOrders">
                  ...
                  <div class="form-group">
                    ...
                    <div class="checkbox-group">
                      <label class="checkbox-label">
                        <input type="checkbox" [(ngModel)]="settings.soundEffects">
